...
# Make filled area plots of DO + H2S with geom_area

# C212_2
C212_2_panel1 <- ggplot(C212_2) +
  geom_line(aes(y = BAT, x = depth), color="black", size=1.5, na.rm = T) +
  geom_area(aes(y = oxygen/300, x = depth), fill = "cyan", alpha = 0.4) +
...
C212_2_panel2 <- ggplot(C212_2) +
  ...
  geom_area(aes(y = oxygen/8, x = depth), fill = "cyan", alpha = 0.4) +
...
C212_2_panel3 <- ggplot(C212_2) +
  geom_line(data = C212_2[!is.na(C212_2$NH4),], aes(y = NH4, x = depth), color="red", size=.8, na.rm = T, lty = 1) +
  geom_point(aes(y = NH4, x = depth), shape = 21, colour = "red", fill = "white", size = 3) +
  geom_line(data = C212_2[!is.na(C212_2$NO_x),], aes(y = NO_x, x = depth), color="green", size=1.3, na.rm = T, lty = 3) +
  geom_point(aes(y = NO_x, x = depth), shape = 21, colour = "green", fill = "white", size = 3) +
  geom_area(aes(y = oxygen/8, x = depth), fill = "cyan", alpha = 0.4) +
...
plot_grid(C212_2_panel1, C212_2_panel2, C212_2_panel3, labels = "AUTO", nrow = 1)
